...
<body class="">                      
  <div class="wrapper ">
   ...
   <?php
   $x= $_SESSION['user_ID'];
   $query = "SELECT * FROM forum,users,login WHERE login.login_id = users.user_ID AND users.user_ID = forum.user_ID AND users.user_ID = ?";
  ...
  <?php
    if ($num > 0)
    {
        while($row = $run->fetch(PDO::FETCH_ASSOC))
          { 
            $path4 = "../../FORUM/".$row["forum_attachment"];
  ...
  <div id="main_inner" class="fluid">
    <div id="primaryContent_columnless">
      <div id="columnA_columnless">
        ...
        <img width="30%" src="<?php echo $path4;?>" class="floatTL" alt="Something scenic" />
        ...
        <div class="post">
          ...
          <ul class="post_info">
            ...
            <li class="comments"> <a href="my_forum_show_comment.php"><?php echo $aa['COUNT(comment.forum_id)'];?> comments</a></li></h3>
          </ul>
        </div>
        <form method="POST" action="comment_hand.php">
          <label>Comment</label>
