...
<body class="">                      
  <div class="wrapper ">
   ...
   <?php
   $x= $_SESSION['user_ID'];
   $query = "SELECT * FROM event_, users, login WHERE login.login_id = users.user_ID AND users.user_ID = event_.user_ID";
  ...
  <div id="main_inner" class="fluid">
    <div id="primaryContent_columnless">
      <div id="columnA_columnless">
        <h3><?php echo $row["event_tittle"];?></h3>
        ...
        <div class="post">
          <h3>Event </h3>
          <ul class="post_info">
            <h3><li class="date">Posted by <a href="#"><?php echo $row["f_name"]." ".$row["l_name"]; ?></a> on <?php echo date("Y/m/d h:i:sa");?></li>
          </ul>
        </div>
