                        <div class="table-data__tool-right">
                                        <button class="au-btn au-btn-icon au-btn--green au-btn--small" data-toggle="modal" data-target="#myModal">
                                            <i class="zmdi zmdi-plus"></i> Add Forum</button>
                    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        
                        <div class="modal-body">
                            <form method="post" action="popup1_handler.php" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="email">Forum tittle</label>
                                    <div class="input-group pb-modalreglog-input-group">
                                        <input type="txt" class="form-control" id="email" name="f_name" placeholder="Forum tittle">
                                        <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label for="description">Description of the Forum</label>
                                    <div class="input-group pb-modalreglog-input-group">
                                        <input type="txt" class="form-control" id="pws" name="description" placeholder="Description of the Forum">
                            ...
                            <button class="btn btn-secondary">Create forum</button>
                            </form>
